...
public class CommonUtil {
	 ...
	 * @return
	 */
	public static String getEmail(String tel, String name) {
		StringBuffer sb = new StringBuffer();
		int flag = getNum(0, 2);
		if (flag == 0) {
			sb.append(tel);
		} else if (flag == 1) {
			sb.append(PingYinUtil.getFirstSpell(name));
			sb.append(tel);
		} else {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 20; i++) {
			...
			String tel = getTel();
			String email = getEmail(tel, name);
			System.out.println(name + " ==> " + tel + " ==> " + email);
			System.out.println("########################################");
			// buffer.append(i + 1).append("\r");
		}
		//
		// FileWriter writer;
		// try {
		// writer = new FileWriter("E:/tel.txt");
