...
public final class DateUtil {
	 ...
	 * dd/MM/yy
	 */
	public static final String FORMAT16 = "MM/dd/yy";

	/**
	 * yyyyMMddHHmm
	 */
	public static final String FORMAT17 = "yyyyMMddHHmm";
	...
	public static Date addOneDay(Date date) {
		return getDateAfterDays(date, 1);
	}
	 ...
	 * @return
	 */
	public static Date parseDateToDay(Date date) {
		return parseStringToDate(parseDateToString(date, FORMAT1), FORMAT1);
	}
	...
	public static Date getCurrentMonthFirstDay(Date date) {
		String dateStr = parseDateToString(date, FORMAT14);
		date = parseStringToDate(dateStr, FORMAT14);
		return date;
	}
	...
	public static void main(String[] args) {
		System.out.println(parseDateToString(parseDateToDay(new Date()), null));
