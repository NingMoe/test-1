...
public class HttpClientUtil {
	 ...
	 * @param contentType
	 *            指定Content-Type属性,若未指定则会使用HttpClient内部默认的ISO-8859-1
	 * @param encodeCharset
	 *            编码字符集,编码请求数据时用之,此参数为必填项(不能为""或null)
	 * @return 远程主机响应正文
	 */
	public static Map<String, Object> sendPostRequest(String reqURL, String reqData, String contentType, CookieStore cookieStoreInit, String encodeCharset,
			Integer connTimeOut, Integer soTimeOut) {
		String respContent = "通信失败"; // 响应内容
		Map<String, Object> respObject = new HashMap<String, Object>(); // 返回对象
		DefaultHttpClient httpClient = new DefaultHttpClient(); // 创建默认的httpClient实例
		// 如果需要带上第一次请求的Cookie
	...
	public static Map<String, Object> sendPostRequest(String reqURL, String reqData, CookieStore cookieStoreInit, String encodeCharset, Integer connTimeOut,
			Integer soTimeOut) {
		return sendPostRequest(reqURL, reqData, "application/x-www-form-urlencoded", cookieStoreInit, encodeCharset, connTimeOut, soTimeOut);
	}
