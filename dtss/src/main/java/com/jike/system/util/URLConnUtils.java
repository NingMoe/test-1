...
public class URLConnUtils {
	...
	private static Logger log = LoggerFactory.getLogger(URLConnUtils.class);
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		String param = "sadfa风动旛动";
		String paramUTF8 = new String(param.getBytes(), "UTF-8");
		log.info("POST请求参数: {}", param);
		log.info("POST请求参数: {}", paramUTF8);
		log.info("POST请求参数: {}", new String(param.getBytes("UTF-8"), "UTF-8"));
		log.info("POST请求参数: {}", new String(param.getBytes(), "GBK"));
		log.info("POST请求参数: {}", new String(param.getBytes("UTF-8"), "GBK"));
		log.info("POST请求参数: {}", new String(param.getBytes()));
